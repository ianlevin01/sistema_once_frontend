...
export const getProductsForReorder   = (limit)      => api.get(`/products?limit=${limit}`);
...
export const sendEmailCampaign  = (subject, html, test_email) =>
  api.post("/email-campaign/send", { subject, html, ...(test_email ? { test_email } : {}) });
